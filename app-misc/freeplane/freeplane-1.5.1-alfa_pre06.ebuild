...
src_install() {
	...
	java-pkg_dolauncher ${PN} --java_args "-Dfreemind.base.dir=${EPREFIX}${dest}" \
		--pwd "${EPREFIX}${dest}" --main freeplane.main.FreePlaneStarter

	newicon "${S}/images/FreePlaneWindowIcon.png" freeplane.png

	make_desktop_entry freeplane Freeplane freeplane Utility
}
